        ...
        try:
            ...
            for cache_file in self.cache_dir.iterdir():
                if cache_file.is_file():
                    ...
                    logging.info("Parsing SimpleCache file: %s", self.cache_file)
                    # Open each cache file in binary mode
                    with open(self.cache_file, 'rb') as c_file:
                        ...
                        if cache_entry.gather_cache_file_headers():
                            ...
                            if cache_entry.read_cache_file():
                                ...
                                if stream_0:
                                    ...
                                    row_headers, out_extension, content_encoding = extract_meta(metadata, self.cache_file, cache_entry.cache_entry.SimpleCacheHeader.header_key_name, self.dynamic_row_headers)
